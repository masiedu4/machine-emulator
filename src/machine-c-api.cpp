...
int cm_send_cmio_response(cm_machine *m, uint16_t reason, const unsigned char *data, size_t length, char **err_msg) try {
    auto *cpp_machine = convert_from_c(m);
...
int cm_verify_send_cmio_response_log(uint16_t reason, const unsigned char *data, size_t length, const cm_access_log *log,
